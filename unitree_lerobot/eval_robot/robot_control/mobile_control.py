...
class G1_Mobile_Lift_Controller:
    def __init__(
        ...
        self.g1_height_action_array_out = Array(
            "d", 1, lock=True
        )  # For receiving published height action values, ready to save to dataset
        ...
        if self.base_type == "mobile_lift":
            ...
            self.g1_move_action_array_out = Array(
                "d", 2, lock=True
            )  # For receiving published movement action values, ready to save to dataset
